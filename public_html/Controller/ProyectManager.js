...
function paintApixel (pX, pY, pW, pH, pColor) {  
    var designCanvas = document.getElementById("_Canvas").getContext("2d");
    designCanvas.fillStyle = "" + pColor;
    designCanvas.fillRect(pX, pY, pW, pH);
    designCanvas.stroke(); 
};
...
function mouseCoordinates () {
    var designCanvas = document.getElementById("_Canvas").getContext("2d");
    var status = document.getElementById("statusMouse");
    var positionMouseX = event.clientX - designCanvas.canvas.offsetLeft;
    var positionMouseY = event.clientY - designCanvas.canvas.offsetTop;
    status.innerHTML = positionMouseX+" | "+positionMouseY;
};
